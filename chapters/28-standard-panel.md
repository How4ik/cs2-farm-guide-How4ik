...
![](images/standard-panel/UglpanZvcgGxMER99YD6.png)
...
1. Скачиваем и устанавливаем [Avast Premium Security](https://www.avast.com/premium-security)\
   [Как правильно установить Avast](https://standard-arb.gitbook.io/standard-arb-docs/dopolnitelnye-nastroiki/ustanovka-avast)
...
3. Открываем Avast -> Меню\
   ![](images/standard-panel/0wt6yGr2s8OnMYaMvP8M.png)
4. Настройки\
   ![](images/standard-panel/Z83oyPtOcZCRszaCz0xQ.png)
5. Поиск\
   ![](images/standard-panel/Ss54bTwW1p3924tcIbNj.png)
6. В поле вводим `geek:area` и нажимаем на `Секретные дополнительные настройки`\
   &#x20;![](images/standard-panel/LZLtKeOoPanIqm3zaudV.png)
7. Находим `Песочница` и ниже будет настройка "`Exclusions`" и нажимаем на кнопку "`Edit`"\
   ![](images/standard-panel/0wGJpiflM4ygSmJpW50L.png)
8. В открывшемся окне вставляем эти строки. \
   ⚠️ **Не важно NVIDIA у вас или AMD.**\
   \
   ⚠️⚠️**Проверьте путь до папки Steam и игры.**\
   \
   ⚠️⚠️⚠️**Поменяйте** \<USERNAME> **на своё имя юзера.**
...
9. Нажмите кнопку "**Save**"\
   ![](images/standard-panel/X8UvksUyc8a8qxL6vzDo.png)
...
![](images/standard-panel/6R83gS19WBRoGHi4ci2r.png)
...
1. Скачиваем архив с последней версией из Telegram бота [Standard BOT](https://t.me/standard_arb_bot)\
   ![](images/standard-panel/nsw9ipLBVXxJ2BTfzExS.png)
2. Разархивируем в любое удобное место.
3. Запускаем "Standard.Desktop.exe".\
   ![](images/standard-panel/Eye5xjsX9eR7yMTGw6Zk.png)
...
6. Выбираем `Мои подписки`\
   ![](images/standard-panel/TZoHgIpR5Q7u3TkNQ0y4.png)
7. Выбираем подписку которую ходим активировать.\
   ![](images/standard-panel/IU5EK2EFEIJpMpNBs4Od.png)
8. Нажимаем `Активировать лицензию`\
   ![](images/standard-panel/Z9PJMUjczplgaRxSYiFm.png)
9. Откройте файл HWID.txt и скопируйте содержимое в буфер обмена.
10. Отправьте содержимое боту как сообщение.\
    ![](images/standard-panel/aBgkVMsapuez4KM72Lpy.png)
...
12. Запускаем "Standard.Desktop.exe" ещё раз. Теперь она должна запуститься.\
    ![](images/standard-panel/M8ztn7CWN2dskiBI6Cif.png)

# Шаг 4. Отключение Smart Screen

{% hint style="warning" %}
Предварительно [отключите Фильтр SmartScreen в Windows 10](https://standard-arb.gitbook.io/standard-arb-docs/prochee/otklyuchenie-smartscreen-v-windows-10)
{% endhint %}
...
![](images/standard-panel/uwLUUWo1YZ03MSrH7Wse.png)
...
1. Нажимаем кнопку Settings\
   ![](images/standard-panel/CvqCG6UyYSmwbE1n6n4B.png)

2. Перед вами откроется окно настроек.\
   ![](images/standard-panel/jZl1hWyw6RbTOcemeetX.png)
...
1. В контекстном меня выбираем "Setup" -> "Import accounts"\
   ![](images/standard-panel/om8zJwvUqdHPKvYpUS54.png)
...
3. Выберите файл(ы)\
   ![](images/standard-panel/92vKddUtGC7FxCdp63VZ.png)
...
8. Спарсите Lvl аккаунтов.\
   ...
   ![](images/standard-panel/joT8wcb56DF7IVPL1zOW.png)
...
![](images/standard-panel/5sIo6Ea69PYZdX5JXLu8.png)
...
![](images/standard-panel/l8ikitkkjDJtNea7BtZt.png)

* Если нет, то нажимаем кнопку "Использовать рекомен. параметры"\
  ![](images/standard-panel/P3l1g3Maifan1J2Pti87.jpg)

* **SRT** встроенный в программу выглядит вот так:\
  ![](images/standard-panel/xR8vtZX8R8hltbgHD89b.png)<br>
...
* Для того что бы выбрать лучший сервер переходим на сайт \
  ...
  ![](images/standard-panel/3dj1pFZiM8ycEYfBr85R.jpg)\
...
* Выбираем один из них -> находим в таблице -> выбираем ->\
  ...
  ![](images/standard-panel/IkJUT3vV9LgrKcqlphen.png)<br>
...
1. Перед первым запуском панели. На аккаунтах нужно спарсить Private LvL и Exp.\
   ![](images/standard-panel/DYAxHgt5Du93Sb0ZLyg2.png)
...
![](images/standard-panel/fwnCZMcorLUCexQuHWVT.png)

3. Теперь можно начинать фарм. Жмём Start и с этого момента ваше участие не требуется.\
   ![](images/standard-panel/oDmDHTlpl0CaqTO46lPC.png)
...
![](images/standard-panel/K4u0lg2giGQYms0MO7Lu.png)

2. Перед вами открое окно сборщика дропа.\
   ![](images/standard-panel/THg8Av8eoZy2NdVGogzM.png)\
   \
...
![](images/standard-panel/li5ve3wPVMIEMoG1yBuG.png)
...
С [прокси](https://t.me/node_proxy_bot?start=87083713) возможна работа единовременно любого количества аккантов. 👉🏻 [Настройка](https://standard-arb.gitbook.io/standard-arb-docs/prochee/gde-i-kak-importirovat-proksi)
{% endhint %}
...
![](images/standard-panel/fYljDRRaggkJIvmy8jGX.png)
...
![](images/standard-panel/13TkpqL9hB9UylY2lN0k.png)
...
![](images/standard-panel/UBEc5eGKNtVcHBvWA5um.png)
...
![](images/standard-panel/YKIeMB2Chzx8jdy2n8jC.png)
...
![](images/standard-panel/OQLJdnyJLnyY8GaCwiqh.png)
...
После импорта и парсинга LVL аккаунтов из [Шаг 6. Импорт аккаунтов](https://standard-arb.gitbook.io/standard-arb-docs/nachalo/shag-6.-import-akkauntov), следует закупить Armory pass.
...
![](images/standard-panel/ujthSiJpRVz6J9C4XP4m.png)
...
![](images/standard-panel/AhcdckOSZPM0ttaVd8vb.png)

Аккаунты выделенные небесно-голубым цветом будут фармить Armory Pass

![](images/standard-panel/zuxasM15rwzacnJdvjgy.png)

4. Непосредственно запуск фарма в вкладке "Controls"
5. Выбираем параметр "Start".

![](images/standard-panel/zWiISXpQggFj2t70fGWE.png)

После старта должен запуститься процесс фарма (открытие аккаунтов стим и игр соответственно)

![](images/standard-panel/vrOMz74tYRKd9Pow52sJ.png)

Когда на первых 6-ти аккаунтах из пачки завершается фарм звёзд Armory pass оно само не остановится и нужно этот момент контролировать (для этого подойдет настройка уведомлений через ТГ-бота [Telegram Notifications](https://standard-arb.gitbook.io/standard-arb-docs/telegram-notifications)). &#x20;

По окончании фарма отключаем его "Controls" ----> "Stop"

![](images/standard-panel/TcWzwNdjGSZi3sLpS5SO.png)
...
![](images/standard-panel/8QNQjPGk6buIviEwCBLE.png)
...
![](images/standard-panel/DrualXJggsWL6HdjxPWk.png)

Обновлённый интерфейс:

![](images/standard-panel/WzqWJliyd0w15UGORuwp.png)
...
![](images/standard-panel/2DkACrssm6gbfE6iot4w.png)
...
{% hint style="info" %}
Если по какой-то причине вы хотите наиграть ничьи,  выкрутите ползунок Tie probability в 100%\ 

![](images/standard-panel/VUpCbrsnktPt1Reu52j6.png)
...
![](images/standard-panel/UIZaXiUllaUSMyCaBR5s.png)
...
[ПО и гайд как это сделать доступно по этой ссылке.](https://standard-arb.gitbook.io/standard-arb-docs/prochee/nastroika-rdp-i-parallelnogo-farma)
...
![](images/standard-panel/xcjmJrZFomvZAh2Q2MOS.png)
...
![](images/standard-panel/DVuJNWYlLxVBUlB9mU09.png)

![](images/standard-panel/rx07aadytp68PgKVEPxj.png)

</details>

Последний шаг это сохранение подготовленных задач.<br>

![](images/standard-panel/oxtIOcbBQDX88IvcnNJS.png)

## Обзор

Сердцем Activity Booster является **Task Scheduler** найти его можно на вкладке Activity Booster.

![](images/standard-panel/t9HwmqhRSFUH228eD3Xw.png)
...
![](images/standard-panel/JwPSjeePiMofnocrTwPB.png)
...
![](images/standard-panel/gadNW8Jaw9nuDL87XpG7.png)

![](images/standard-panel/rrTzws9A26qQdHnjZLPM.png)

# Account Management

Account Manager - позволяет автоматизировать рутинные действия на аккаунтах.

![](images/standard-panel/TjKHiQXzvQ3BADK9MZ8h.png)
...
![](images/standard-panel/ElMGciJQThHAcecld0QI.png)
...
10. **Armory Store Item** - тут можно выбрать какие предметы будут закупаться в Armory Store командой **Buy items in armory store**\ 

![](images/standard-panel/WwCJeNT7zhysK5jDofGX.png)
...
![](images/standard-panel/y3zqfwq79432l6bjZYtm.png)
 Кнопка открывающая настройки **Лутинга**. Более подробно о нём в следущем разделе.\ <a href="/pages/xx8CPUpXtXvSz7NnM3Wb" class="button primary">Перейти к разделу Looter Settings</a>
...
![](images/standard-panel/vC8zh6OhDPocsWCMYDfx.png)
...
![](images/standard-panel/4UHlJmJfEw0dKMAM9MYB.png)
 в правом верхнем углу списка аккаунтов откроет окно настроек.

![](images/standard-panel/clAPVDT6TUKN8Wx2etP9.png)
...
![](images/standard-panel/ZnHo3bQh10P4N9DzRviv.png)
 позволяет мягко **включить/отключить прокси** по всей программе.
...
![](images/standard-panel/kMb9bJgvJBDfrRnB3kfV.png)
 - во включенном состоянии предметы не подлежащие продажи на торговой площадке будут игнорироваться и не будут сохраняться в программе.
...
![](images/standard-panel/ZuaX6tVs4LKGc6bvGpjc.png)

Окно настройки инвентарей с которыми программу будет работать. Тут нужно добавить и сохранить интересующие вас AppId/ContextId. Список поддерживаемых кликеров для добавления в 1 клик доступен в выпадающем списке под списком инвентарей ![](images/standard-panel/3N1XOGhEr9eP5jepUGzo.png)

![](images/standard-panel/JaD7uFHyd4t3hmY2b2Bm.png)

В поле ![](images/standard-panel/VQucDiYnH2NlF8RvifJO.png) вы можете ввести своё сочетание AppId/ContextId и добавить в общий список. К примеру для Steam предметов(карточки, фоны, дизайн профиля) это будет 753/6, для всех остальных игр AppId/2.

**Удалить добавленные инвентари** вы можете кликнул ПКМ по строке в списке и нажав Remove

![](images/standard-panel/HQUiVps55CDwCHHfVfKM.png)

Или выбрав в списке не нужный инвентарь и нажать кнопку ![](images/standard-panel/RZrvrDgCGuUBUiKKfa6d.png)После завершения редактирования нужно нажать кнопку 

![](images/standard-panel/0zpZSdwfFyKNuFJgyWm3.png)
...
![](images/standard-panel/hcNKWnKF6UA6oWSaPIyy.png)

Состоит из логина аккаунта и ID в таблице аккаунтов.\
Кнопка ![](images/standard-panel/INcW7ptKAL3dtiygJuHX.png)позволяет обновить информацию о балансе аккаунта.\
![](images/standard-panel/yrITOLoEHmWP2qijJQBy.png)при наведении на него будут показан последний лог событий для аккаунта. Если есть новые события будет выглядеть вот так ![](images/standard-panel/9ajfGIO8LzM2qoAmItak.png)\ 

![](images/standard-panel/Dz5lCygb9Qn1OK3fc7Kx.png)
\
\
...
Кнопка ![](images/standard-panel/0Wikl8CSZ3k2RYI9MNZs.png)обновляет инвентарь аккаунта.\
Кнопка   ![](images/standard-panel/7LAf0OxKuB09BvBHlXbM.png) обновляет листинги аккаунта.

Рядом с логином аккаунта вы можете увидеть значок ![](images/standard-panel/63aHzcFyBcn64JsAQI2J.png) сообщающий вам что программа не знает имеет ли аккаунт доступ к торговой площадке. Если на него нажать программа проверит имеется ли такая возможность.

После того как вы выберете 1 или более аккаунтов в верхней части появятся новые кнопки\
![](images/standard-panel/10hdpjPFDCOiHbgCAwI9.png)

Они позволят обновить информацию о балансе, инвентарь или листинги для всех выбранных аккаунтов в многопоточном режиме.\
Кнопка 

![](images/standard-panel/NvGkkxOhYX2mdoDWTU6P.png)
 снимет выделение со всех аккаунтов.

### Инвентарь

В правой части экрана находится обозреватель инвентаря:

![](images/standard-panel/SENY1ggUme3Q0Ki9yQv1.png)
...
![](images/standard-panel/nUksouRBZ3ow2swZENLm.png)
...
![](images/standard-panel/0id725W2vSWKnXjdAQWw.png)

Для автоматической оценки(на момент написания гайда) доступны 2 режима:

* 

![](images/standard-panel/zDXemSG7k9mTRWiSHwfo.png)
 - установит цену продажи по цене самого дешевого листинга предмета.\ 

![](images/standard-panel/GOeg94cwtU2aahj0JidW.png)
установит цену самого дорогого Buy Order для предмета.

В режиме 

![](images/standard-panel/APmAFuJL8O9R9diSEDBz.png)
цены на все предметы вам нужно будет установить вручную, о нём расскажу позже.

После выбора способа оценки вам нужно нажать на одну из кнопок 

![](images/standard-panel/zichH80mVaHwELh9iKeT.png)
<br>

Обе кнопки сделаю одно и тоже - проставят цену для продажи согласно выбранному режиму, но кнопка 

![](images/standard-panel/g4wDtpQHwNjgd7oMqJ4x.png)
 перед запросом цены в Steam проверит есть ли в кеше цена. Если она есть будет использовано старое значение, если ничего нет будет получена актуальная цена с торговой площадки.\
\
Кнопка 

![](images/standard-panel/IULHNhwjKTzf0gqgFoUF.png)
 проигнорирует кешированные данные и получит актуальные с торговой площадки.

После завершения оценки вы получите результат похожий на:

![](images/standard-panel/xok4GMSGKNgSkiIBjD3g.png)
...
![](images/standard-panel/1fgcHYyqdWmvSzjbajOP.png)

Если вы нажмёте Price manually у вас откроется окно запроса цены:

![](images/standard-panel/tdzvayghwGcmMhaBt99z.png)
...
![](images/standard-panel/vnLmPK0nlJGPAFwFAD3g.png)
 позволяет скопировать название.\
Кнопка 

![](images/standard-panel/63YBoZQDneOZzJD7sSPl.png)
 откроет в браузере ссылку на предмет на торговой площадке Steam.
...
![](images/standard-panel/yP17Cl6OCq8KGHL4Q8BG.png)

Кнопка 

![](images/standard-panel/6uESEh1LVJloY5CzFOHD.png)
 обновит листинги на выбранных аккаунтах.\
После обновления исполненные продажи получат галочку в столбце Complited<br>

![](images/standard-panel/Pt4jdTHkQHTTcgsyXiKe.png)
...
![](images/standard-panel/za61ZEywYO4TYUmCtxk7.png)
 позволяет отменить все листинги на всех аккаунтах.

# Как купить игру/набор игр

На вкладке Management находим кнопку "Open game purchase dialogue"

![](images/standard-panel/QKUBcS5sIXGpx9rDEXww.jpg)

Откроется окно покупки игр.

![](images/standard-panel/22HiE9QjifHRdzU7d0Zy.png)
...
![](images/standard-panel/Wzr7EdVAT1fVE6m8u7yW.png)

2. В открывшемся окне импортируем прокси и устанавливаем количество потоков.

![](images/standard-panel/ISD5xkCoRx4aOb9EeDv9.png)
...
![](images/standard-panel/FwChFlZ7zRi7Jx1Jsk6L.png)

6. Выбираем предметы которые хотим продать <br>

   

![](images/standard-panel/fGVojQHZ9oFtiIDdEOkG.png)
...
![](images/standard-panel/FGNs37ofT6p0dcDZhP7M.png)

9. После успешной оценки кнопка Sell items станет активна.\ <br>

   

![](images/standard-panel/PFeBL0Bs8o8B8FWhi9pD.png)
...
![](images/standard-panel/UJCHknil0cXGaJFWQ8mX.png)

# Активация Wallet Code

![](images/standard-panel/PqZhY2axejVal3CvXI1s.png)
...
![](images/standard-panel/IW3ajlG3m73PyO7YRhNx.png)
...
![](images/standard-panel/3OJko4hTETj9LlSgxi4E.png)

Затем нажмите **Синхронизировать**

![](images/standard-panel/kl7HcRYf9Q4csfZSxvVC.png)
...
![](images/standard-panel/XljsZFyhPemTkTZ5pEFX.png)

Выбираем наш файл с прокси нажимаем "<mark style="color:green;">**Open**</mark>"

![](images/standard-panel/z7bGaCdwHw10vJi9bCMC.png)
...
![](images/standard-panel/oO6tER6k0hdPkhFo2pFS.png)
...
![](images/standard-panel/dJkn0R4tVDk7s5wftBQ7.png)
...
![](images/standard-panel/1Jn8mBL76GIRiCbrpIgL.png)
...
![](images/standard-panel/Rd78JiyOfXHNivyGUC9p.png)

5. Нажмите кнопку "**Apply**".
6. Перезагрузите компьютер.
7. Откройте "**RDPConf"**, он должен выглядеть вот так.

![](images/standard-panel/SEaGIrT5Ubb86lNpRh3t.png)
...
1. В **StandardRDPClient** откройте меню "**Local Users**" -> "**Add User**"\
   ![](images/standard-panel/R3XIy1Xb86iwl7H1wiur.png)
...
![](images/standard-panel/97ALEWbi9Je653mW6hRw.png)
...
4. **Port** задаём такой же как в "**RDPConf"**\
   ![](images/standard-panel/sCmq3Z4a5whHfTwuZUkl.png)
...
![](images/standard-panel/rSbkFixiNaPlUqQquOFI.png)
...
![](images/standard-panel/11HgGn17hczDQ0aS0smh.png)
...
![](images/standard-panel/1ARByKefNUa3sSDbScnT.png)
...
![](images/standard-panel/6u7rStTzGwBd4cIoFOef.png)

![](images/standard-panel/YC2BPbYI59KKpcvriGMb.png)

![](images/standard-panel/hXxTo73l0oLijvvAGfR9.jpg)
...
![](images/standard-panel/2IL9VCVhrydnTNn1it81.png)

После обновления информации в столбце 

![](images/standard-panel/tSgvujYEGRhpslq50k5c.png)
 будет отображено количество игр для фарма карточек, а в столбце 

![](images/standard-panel/hQ3vWlvOZD2T4kaGxVEJ.png)
 количество карточек которые можно получить.
...
![](images/standard-panel/sIU1eehPzEsP06QbeeT8.png)
...
![](images/standard-panel/Q3uxFan5cnhudL7Ur7rF.png)
...
![](images/standard-panel/e7B7RkY5Z2ps1dGu6p1B.png)

2. Далее выбираем "**Игры**"

![](images/standard-panel/eyFn0dpNzvVt3AV28PRu.png)

3. Ставим переключатель в положение "**Откл.**"<br>

![](images/standard-panel/eOGb7xWWRq0szBlr2ckH.png)

4. Теперь выбираем пункт "Игровой режим" и отключаем его тоже

   

![](images/standard-panel/9VuU6rGDrGGhFJZkMGCB.jpg)
...
![](images/standard-panel/NFL6xAfyPl0hoV4KRvx4.png)
...
![](images/standard-panel/YW3ldz3RP9RM77XyNWSR.png)

3. Нажимаем **Enter** и вы должны получить следующий результат.

![](images/standard-panel/U5PUhhFY05wzUK2QLMzQ.png)
...
![](images/standard-panel/q64ARdgQavRpvWNwSBCC.png)

2. Убираем всё кроме песочницы. Это обязательно!

![](images/standard-panel/Y7yX167PJJtnFgTNIT2B.png)

3. Ожидаем установки

![](images/standard-panel/emKhpXxfxNOyoK9UriBh.png)
...
1. Проверяем версию NVIDIA драйвера.\
   ...
   ![](images/standard-panel/NOgNQKxAIdzWsm7cxaVX.png)
2. Если версия не соответствует [устанавливаем по гайду.](https://standard-arb.gitbook.io/standard-arb-docs/nachalo/shag-1.2-nastroika-avast)
...
![](images/standard-panel/c2dmhj1KMjLAgmg08NPI.png)
...
![](images/standard-panel/qYG4JI5jwrXwdpTQZU81.png)
...
![](images/standard-panel/4CC69aQeNYjlQLC3Shix.png)

4. Итоговый результат должен выглядеть вот так.

![](images/standard-panel/GrcY1ztFUkQPtuXdy0YC.png)

5. Закрываем окно. Перезагружаем компьютер.

## Запускается только одно окно CS2

Убедитесь что [вы правильно установили Avast по гайду.](https://standard-arb.gitbook.io/standard-arb-docs/dopolnitelnye-nastroiki/ustanovka-avast)\
...
1. Переходим в "Settings" -> Вкладка "Maps"\
   ![](images/standard-panel/gQMJU9B1b55iDZETIUuD.png)
...
4. Переключатель "**Enable Shooting mode**" переводим в положение **On**\
   ![](images/standard-panel/3d8A8ukXkkdlhQmtZlFj.jpg)
